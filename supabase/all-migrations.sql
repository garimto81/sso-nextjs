-- ===================================================================
-- ALL SUPABASE MIGRATIONS (Combined)
--
-- Purpose: Run all migrations in one go
-- Created: 2025-01-14
-- ===================================================================
--
-- ℹ️  Copy this ENTIRE file and run in Supabase Dashboard SQL Editor
--
-- ===================================================================
...
CREATE POLICY IF NOT EXISTS "Admin can view all login attempts"
...
CREATE POLICY IF NOT EXISTS "Service role can insert login attempts"
...
-- RLS Policy: Admin만 조회 가능
CREATE POLICY IF NOT EXISTS "Admin can view all lockouts"
